...
var parser = (function(){
    var parser = {trace: function trace(){},
        yy: {},
        symbols_: {"error":2,"program":3,"expressions":4,"EOF":5,"function_definition":6,";":7,"FUNCTION":8,"function_name":9,"(":10,"parameters_definition":11,")":12,"{":13,"functionBody":14,"}":15,"ID":16,",":17,"expression":18,"variable_definition":19,"graph_definition":20,"GRAPH":21,"variable_name":22,"$accept":0,"$end":1},
        terminals_: {2:"error",5:"EOF",7:";",8:"FUNCTION",10:"(",12:")",13:"{",15:"}",16:"ID",17:",",21:"GRAPH"},
        productions_: [0,[3,2],[4,0],[4,3],[6,8],[9,1],[11,0],[11,1],[11,3],[14,0],[14,3],[18,1],[19,1],[20,2],[22,1]],
        performAction: function anonymous(yytext, yyleng, yylineno, yy, yystate /* action[1] */, $$ /* vstack */, _$ /* lstack */
            ...
            var $0 = $$.length - 1;
            switch (yystate) {
                case 1:return y.program($$[$0-1]);
                    break;
                case 2:this.$ = ''
                    break;
                case 3:this.$ = $$[$0-2] + $$[$0];
                    break;
                case 4:this.$ = y.function_definition({name: $$[$0-6], defParameters: $$[$0-4], functionBody: $$[$0-1]})
                    break;
                case 5:this.$ = $$[$0]
                    break;
                case 6:this.$ = ''
                    break;
                case 7:this.$ = y.parameters($$[$0])
                    break;
                case 8:this.$ = y.parameters($$[$0-2], $$[$0])
                    break;
                case 9:this.$ = ''
                    break;
                case 10:this.$ = y.expression($$[$0-2]) + $$[$0];
                    break;
                case 11:this.$ = $$[$0];
                    break;
                case 12:this.$ = $$[$0]
                    break;
                case 13:this.$ = y.declareGraphVar($$[$0]);
                    break;
                case 14:this.$ = $$[$0]
                    break;
            }
        },
        table: [{3:1,4:2,5:[2,2],6:3,8:[1,4]},{1:[3]},{5:[1,5]},{7:[1,6]},{9:7,16:[1,8]},{1:[2,1]},{4:9,5:[2,2],6:3,8:[1,4]},{10:[1,10]},{10:[2,5]},{5:[2,3]},{11:11,12:[2,6],16:[1,12]},{12:[1,13]},{12:[2,7],17:[1,14]},{13:[1,15]},{11:16,12:[2,6],16:[1,12]},{14:17,15:[2,9],18:18,19:19,20:20,21:[1,21]},{12:[2,8]},{15:[1,22]},{7:[1,23]},{7:[2,11]},{7:[2,12]},{16:[1,25],22:24},{7:[2,4]},{14:26,15:[2,9],18:18,19:19,20:20,21:[1,21]},{7:[2,13]},{7:[2,14]},{15:[2,10]}],
        defaultActions: {5:[2,1],8:[2,5],9:[2,3],16:[2,8],19:[2,11],20:[2,12],22:[2,4],24:[2,13],25:[2,14],26:[2,10]},
